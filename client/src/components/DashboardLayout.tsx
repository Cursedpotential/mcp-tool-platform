...
import { LayoutDashboard, LogOut, PanelLeft, Wrench, BarChart3, Settings, FileText, ScrollText, Server, GitFork, Key, BookOpen, Cpu } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Cpu, label: "MCP Config", path: "/mcp-config" },
