...
**Storage Architecture:** We are building a **Zep AI clone** using the open-source **Graphiti library** for temporal knowledge graphs. See **STORAGE_ARCHITECTURE.md** for the definitive 4-tier storage design (Chroma → MySQL/PostgreSQL → pgvector → Neo4j+Graphiti).
