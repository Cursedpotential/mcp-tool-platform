...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    description:
      "Full document processing pipeline: OCR, entity extraction, sentiment analysis, and summarization",
    category: "document",
    tags: ["document", "nlp", "ocr", "analysis"],
    complexity: "complex",
    useCase:
      "Process scanned documents or PDFs to extract structured information",
    steps: [
      {
        toolName: "format.ocr",
  ...
  },
  {
    ...
    description:
      "Analyze chat conversations for manipulation patterns, severity scoring, and evidence chains",
    category: "forensics",
    tags: ["forensics", "chat", "analysis", "evidence"],
    complexity: "complex",
    useCase:
      "Analyze chat logs for abusive patterns, gaslighting, and create forensic evidence",
    steps: [
      {
        toolName: "forensics.analyze_patterns",
        description:
          "Detect manipulation patterns (gaslighting, isolation, etc.)",
      },
      {
    ...
    example: {
      ...
      expectedOutput:
        "Forensic report with patterns, severity, and evidence chain",
    },
  },
  {
    ...
    description:
      "Prepare documents for semantic search: chunk, embed, and index in vector database",
    category: "ml",
  ...
  },
  {
    ...
    description:
      "Extract structured data from documents and map to target schema",
    category: "document",
    tags: ["extraction", "schema", "data", "mapping"],
    complexity: "medium",
    useCase:
      "Extract structured data from unstructured documents and normalize to target schema",
    steps: [
      {
