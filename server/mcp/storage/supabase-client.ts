...
export class SupabaseManager {
  ...
  async insertEmbeddings(
    ...
    const { error } = await this.client.from("embeddings").insert(embeddings);
  ...
  async insertEmbedding(
    embedding: Omit<EmbeddingRow, "created_at">
  ): Promise<void> {
  ...
  async semanticSearch(
    ...
    console.log(
      `[SupabaseManager] Semantic search (threshold: ${matchThreshold}, count: ${matchCount})`
    );
  ...
  async deleteDocumentEmbeddings(documentId: string): Promise<void> {
    console.log(
      `[SupabaseManager] Deleting embeddings for document: ${documentId}`
    );
  ...
  async insertDocument(
    ...
    const { error } = await this.client.from("documents").insert(document);
  ...
  async insertDocuments(
    documents: Omit<DocumentRow, "indexed_at">[]
  ): Promise<void> {
    console.log(`[SupabaseManager] Inserting ${documents.length} documents`);

    const { error } = await this.client.from("documents").insert(documents);
  ...
  async insertChunks(chunks: ChunkRow[]): Promise<void> {
    ...
    const { error } = await this.client.from("chunks").insert(chunks);
  ...
  async deleteDocumentChunks(documentId: string): Promise<void> {
    console.log(
      `[SupabaseManager] Deleting chunks for document: ${documentId}`
    );
  ...
  async insertDocumentComplete(
    ...
    console.log(
      `[SupabaseManager] Inserting complete document: ${document.id}`
    );
  ...
  > {
    const { data, error } = await this.client.rpc("get_case_embedding_stats", {
  ...
  > {
    const { data, error } = await this.client.rpc("find_duplicate_chunks", {
