...
describe("Agent-Friendly MCP Gateway", () => {
  describe("listTools", () => {
    ...
    it("should filter by category", async () => {
      ...
      expect(result.success).toBe(true);
      expect(result.data?.tools.every(t => t.category === "document")).toBe(
        true
      );
    });
  ...
  describe("getToolsByCategory", () => {
    ...
    it("should return empty array for non-existent category", async () => {
      ...
      const result = await caller.getToolsByCategory({
  ...
  describe("getRelatedTools", () => {
    it("should return related tools for a given tool", async () => {
      ...
      expect(
        result.data?.every(t => t.name !== "forensics.analyze_patterns")
      ).toBe(true);
    });
  ...
  describe("semanticRoute", () => {
    ...
    it("should calculate confidence scores", async () => {
      ...
      const highConfidence = await caller.semanticRoute({
        intent:
          "analyze chat conversation for gaslighting and manipulation patterns",
      });
