...
export const NOTEBOOKLM_TOOLS: NotebookLMTool[] = [
  {
    name: "notebooklm.ask",
    description:
      "Ask a question to NotebookLM and get a zero-hallucination answer from your curated documents. Returns citation-backed responses.",
    inputSchema: {
      type: "object",
      properties: {
        question: {
        ...
        notebook_url: {
          type: "string",
          description: "Optional: specific notebook URL to query",
        },
      },
      required: ["question"],
    },
  },
  {
    ...
    description:
      "List all notebooks in the NotebookLM library with their tags and descriptions.",
    inputSchema: {
      type: "object",
      properties: {},
      required: [],
  ...
  },
  {
    ...
    description:
      "Select a notebook by name or URL to use for subsequent queries.",
    inputSchema: {
      type: "object",
      properties: {
        identifier: {
          type: "string",
          description: "Notebook name or URL to select",
        },
      },
      required: ["identifier"],
    },
  },
  {
    name: "notebooklm.add",
    description:
      "Add a new notebook to the library with tags for automatic selection.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        description: {
          type: "string",
          description: "Optional description of notebook contents",
        },
      },
      required: ["url", "name"],
    },
  },
  {
    ...
    description:
      "Search notebooks by tags or name to find relevant knowledge bases.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        identifier: {
          type: "string",
          description: "Notebook name or URL to remove",
        },
      },
      required: ["identifier"],
    },
  },
  {
    ...
    description:
      "Get library statistics including notebook count, query count, and tag distribution.",
    inputSchema: {
      type: "object",
      properties: {},
      required: [],
...
export async function executeNotebookLMTool(
  ...
  try {
    ...
    return {
      success: false,
      error:
        "Failed to connect to NotebookLM MCP. Make sure npx notebooklm-mcp is available.",
    };
  }
  ...
  switch (toolName) {
    ...
    case "notebooklm.add":
      const tags = args.tags
        ...
        : [];
      return {
        success: await client.addNotebook(
          args.url,
          args.name,
          tags,
          args.description
    ...
    case "notebooklm.search":
      return {
        success: true,
        notebooks: await client.searchNotebooks(args.query),
      };
