...
export const timestampPrecisionEnum = pgEnum("timestamp_precision", [
  "exact",
  "approximate",
  "inferred",
]);
...
export const behaviorCategories = pgTable("behavior_categories", {
  ...
  description: text("description"),
  severityDefault: varchar("severity_default", { length: 20 }).default(
    "medium"
  ),
...
export const messagingConversations = pgTable("messaging_conversations", {
  ...
  primaryParticipantNormalized: varchar("primary_participant_normalized", {
    length: 255,
  }), // E.164 format
...
export const messagingMessages = pgTable("messaging_messages", {
  ...
  timestampPrecision: varchar("timestamp_precision", { length: 20 }).default(
    "exact"
  ),
...
export const messagingDocumentsRelations = relations(
  messagingDocuments,
  ({ many }) => ({
...
export const messagingConversationsRelations = relations(
...
export const messagingBehaviorsRelations = relations(
  messagingBehaviors,
  ({ one }) => ({
...
export const messagingEvidenceItemsRelations = relations(
  messagingEvidenceItems,
  ({ one, many }) => ({
    message: one(messagingMessages, {
