...
export const behavioralPatternsRelations = relations(
  behavioralPatterns,
  ({ one }) => ({
    user: one(users, {
...
export const forensicResultsRelations = relations(
  forensicResults,
  ({ one }) => ({
    user: one(users, {
...
export const hurtlexCategoriesRelations = relations(
  hurtlexCategories,
  ({ one }) => ({
    user: one(users, {
...
export const patternCategoriesRelations = relations(
  patternCategories,
  ({ one }) => ({
    user: one(users, {
...
export const schemaResolversRelations = relations(
  schemaResolvers,
  ({ one }) => ({
    user: one(users, {
...
export const severityWeightsRelations = relations(
  severityWeights,
  ({ one }) => ({
    user: one(users, {
...
export const systemPromptsRelations = relations(
  systemPrompts,
  ({ one, many }) => ({
    user: one(users, {
